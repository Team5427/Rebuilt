...
public class HubShiftUtil {
  ...
  private static final double minTimeOfFlight = AimingConstants.kShootingTable.getTimeOfFlight(2.7);
  private static final double maxTimeOfFlight = AimingConstants.kShootingTable.getTimeOfFlight(5.0);
