...
public class ImpartedVelocityTest {
  ...
  public void impartedVelocity() {
    ...
    shoot.setFutureTrackResult(
        new Tuple2Plus<Pose2d, ChassisSpeeds>(Pose2d.kZero, new ChassisSpeeds(0, 0, 0)));
    System.out.println(
        shoot.calculateImpartedVelocity(new Rotation2d(Math.PI / 4.0), MetersPerSecond.of(1.0)));
  }
}
